...
<html lang="en">
  ...
  <body>
    <section class="container-fluid">
      ...
      <form action="action_pinjam.php" class="row g-4" id="form-container"  method="POST">
        <h2>Peminjaman Buku</h2><br>
        <div class="col-12">
        ...
        <div class="col-12">
          ...
          <input type="text" class="form-control" id="inputAddress2" placeholder="Nomor KTP/NIK" name="ktp" required>
        </div>
        <div class="col-12">
          <label for="inputAddress2" class="form-label">Nomor Telepon </label>
          <input type="text" class="form-control" id="inputAddress2" placeholder="Nomor Telepon" name="telp" required>
        </div>
